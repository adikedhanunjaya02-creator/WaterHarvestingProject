...
<head>
  <meta charset="UTF-8">
  <title>AquaVision – Rainwater Harvesting</title>
  <style>
    body { font-family: "Segoe UI", Arial, sans-serif; margin: 0; padding: 0; background: #f0f8ff; }
    header {
    ...
    nav {
      background: #0277bd; padding: 10px; text-align: center;
    }
    nav a {
    ...
    .card {
      ...
      max-width: 800px; transition: transform 0.3s;
    }
    .card:hover { transform: scale(1.02); }
    label { display: block; margin: 10px 0 5px; font-weight: bold; color: #0277bd; }
    input, select {
      width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #ccc; margin-bottom: 12px;
    }
    button {
      background: #0277bd; color: white; padding: 12px 18px;
    ...
    footer {
      background: #01579b; color: white; text-align: center;
